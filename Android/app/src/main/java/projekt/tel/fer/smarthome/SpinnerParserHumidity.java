...
public class SpinnerParserHumidity extends AsyncTask<String, String, LinkedList<Measurement>> {
    Context context;
    OnTaskCompletedHumidity listener;
    HumTabAdapter.ViewHolder viewHolder;

    public SpinnerParserHumidity(HumTabAdapter.ViewHolder viewHolder, OnTaskCompletedHumidity listener, Context context){
        super();
    ...
    protected LinkedList<Measurement> doInBackground(String...urls ) {
        ...
        try {
            ...
            for(Measurement sensor : senzori){
