...
public class DataTaskTemperature extends AsyncTask<String,String,List<Measurement>> {

    OnTaskCompletedTemperature listener;
    Context context;
    TempTabAdapter.ViewHolder viewHolder;
    public DataTaskTemperature(TempTabAdapter.ViewHolder viewHolder, OnTaskCompletedTemperature listener) {
    ...
    protected void onPostExecute(List<Measurement> list) {
        ...
        if(viewHolder instanceof TempTabAdapter.CurrentViewHolder) {
            listener.OnTaskCompletedCurrent(viewHolder, list);
        } else if ( viewHolder instanceof TempTabAdapter.AverageViewHolder) {
